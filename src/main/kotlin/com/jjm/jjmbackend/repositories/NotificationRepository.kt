...
class NotificationRepository {
    ...
    fun create(userId: Int, title: String, message: String, type: String = "SYSTEM", relatedId: Int? = null): Notification? {
        return transaction {
            ...
            insertStatement.resultedValues?.firstOrNull()?.let { mapRowToNotification(it) }
        }
    }
    ...
    private fun mapRowToNotification(row: ResultRow): Notification {
        return Notification(
